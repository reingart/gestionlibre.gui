...
'Address': 'Address',
'Admin user group created': 'Admin user group created',
...
'Disable integrity check': 'Disable integrity check',
...
'Importing from CSV format file': 'Importing from CSV format file',
'Index': 'Inicio',
...
'Plant': 'Plant',
'Please create an administrative user': 'Please create an administrative user',
...
'You should configure a firm tax id to use ordering forms': 'You should configure a firm tax id to use ordering forms',
'abbr': 'abrev',
'account': 'cuenta',
