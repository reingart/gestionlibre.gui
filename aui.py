...
"""
This is an adapted
version of the AUI_DockingWindowMgr wx
The script was originally written Mike Driscoll and
modified by Andrea Gavana

demo python module to be used by
GestiónLibre Desktop GUI
...
__author__ = "Mike Driscoll; Andrea Gavana; Alan Etkin <spametki@gmail.com>"
...
class PyAUIFrame(wx.Frame):
    ...
    def __init__(self, parent, id=-1, title="GestiónLibre", pos=wx.DefaultPosition,
